...
function PixelsChange({color, refresh, pixels, setPixels,socket}) {
    ...
    /*useEffect(()=>{
        ...
        if(document.getElementsByClassName("PixelWrapperChange").length === 0){return;}
        document.getElementsByClassName("PixelWrapperChange")[0].innerHTML = ""
        document.getElementsByClassName("PixelWrapperChange")[0].appendChild(image);
    },[pixels])*/
